...
exports.createPostSchema = {
    body: zod_1.default.strictObject({
        ...
        files: zod_1.default.array(validation_middleware_1.generalFields.file(["image/png"])).optional(),
        tags: zod_1.default.array(zod_1.default.string()).optional(),
        availability: zod_1.default.string().default(auth_enum_1.AvailabilityEnum.PUBLIC)
    })
